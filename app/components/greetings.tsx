const Greetings: React.FC = () => {
    return (
        ...
        <p className="mx-auto text-center relative mt-10 text-xl font-semibold leading-9 tracking-tight text-white sm:w-full sm:max-w-sm">
           Bienvenue sur votre console de gestion pour

...
const Foother: React.FC = () => {
    const currentYear = new Date().getFullYear();

    return (
        <footer>
            <p className="mt-10 text-center text-xs text-white font-medium sm:w-full sm:max-w-sm mx-auto">
                © Kaelian Baudelet. {currentYear} Tous droit réservés. Locked n&apos;est pas affilié à

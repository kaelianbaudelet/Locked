...
export default function WebsiteBrowserCard() {
        ...
        <div className="bg-[#171717] p-7 shadow-lg sm:flex-none rounded-2xl w-full">
            <div className="text-center">
                <h3 className="text-sm font-semibold text-white mb-4 leading-loose">
                    Avec Locked, analysez les sites grâce à votre abonnement
                ...
                <p className="text-xs text-[#a8a8a8] font-semibold">Pour commencer une analyse, saisissez une URL ci-dessous.</p>
            </div>
            ...
            <form
                ...
                method="get"
                action="/action"
                className="group mt-8 relative flex items-center gap-1 w-full rounded-xl border border-[#a8a8a8]/10"
            >
                <input
                    value={url}
                    ...
                    className="text-sm outline-none flex-1 mr-8 p-4 bg-[#171717] rounded-xl placeholder-[#a8a8a8] transition duration-200 text-white font-medium"
                />
                ...
                <svg
                    className="absolute right-4 pointer-events-none fill-[#a8a8a8]"
                    width="20"
                    height="20"
                    viewBox="0 0 512 512"
